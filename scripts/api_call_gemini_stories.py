...
@click.option("--model", type=str, default="gemini-1.5-pro-latest", help="Gemini model to use")
...
def main(filename: str, file_path: str="./", strategy: str="synopsis", 
         temp: Optional[float]=None, iter_nb: str="0", model: str="gemini-1.5-pro-latest",
         num_samples: int=100) -> None:
    """
    Generate creative stories using Google's Gemini API.
    """
...
if __name__ == "__main__":
    logging.basicConfig(
        ...
        handlers=[
            ...
            logging.FileHandler('gemini_stories.log')
        ]
    )
    main()
